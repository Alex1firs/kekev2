...
/// The delayed-ride coordination card.
///
/// This is deliberately NOT an error surface. A driver stuck behind an accident
/// is not a bug, and a card that looks like a crash report teaches passengers to
/// panic at ordinary traffic. So: cream surface, amber accent, plain language,
/// and red used only on the confirmation step of an action that actually ends the
/// ride.
///
...
class _CoordinationCardState extends State<CoordinationCard> {
        ...
        children: [
          ...
          if (c.submitting) ...[
            ...
            _StatusLine(
              ...
              text: 'The time to respond has passed. Your ride is still active '
          ...
          if (c.requestedByMe &&
            ...
            _StatusLine(
              ...
              text: 'Waiting for a response. Your ride stays active until they answer.',
            ),
          ],
  ...
  Future<void> _handle(BuildContext context, CoordinationAction action) async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          action == CoordinationAction.acceptCancellation
              ? 'The ride will end and you can book another Keke.'
              : "We'll ask your driver to confirm. Your ride stays active until they answer.",
          style: AppTextStyles.bodySmall(color: AppColors.darkGray),
        ),
        actions: [
          TextButton(
  ...
  static String _answeredCopy(RideCoordination c) {
    ...
    return 'Your driver has been told you are still waiting.';
  }
