...
class AppColors {
  ...
  // Coordination / informational. A delayed ride is a fact about traffic, not an
  // error, so it gets calm amber on cream rather than anything in the red family.
  // Same values as the passenger app so both sides of one delay look alike.
...
class AppTextStyles {
  ...
  /// network, which is unavailable under `flutter test` — widget tests set this
  /// to a locally registered family so text lays out with real glyph metrics.
  @visibleForTesting
