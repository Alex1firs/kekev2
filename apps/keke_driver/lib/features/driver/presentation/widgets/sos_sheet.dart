...
class _SosSheetState extends ConsumerState<SosSheet> {
  ...
  void _triggerSos() {
    ...
    ref.read(driverControllerProvider.notifier).triggerSos(reason);
            ...
            children: _reasons.map((reason) {
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: isSelected ? AppColors.error : AppColors.darkGray,
                    borderRadius: BorderRadius.circular(20),
                    border: Border.all(color: isSelected ? AppColors.error : AppColors.midGray.withOpacity(0.3)),
                  ),
                  child: Text(
                    reason,
