...
/// Maps transport-level Dio failures to something a driver can act on.
///
...
/// this exception, try raising the RequestOptions.connectTimeout...", which a
/// driver on weak mobile data has no way to interpret.
///
